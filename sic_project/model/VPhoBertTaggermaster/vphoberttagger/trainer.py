...
from .constant import LOGGER, MODEL_MAPPING, LABEL_MAPPING
from model.VPhoBertTaggermaster.vphoberttagger.helper import set_ramdom_seed, plot_confusion_matrix, get_total_model_parameters

from model.VPhoBertTaggermaster.vphoberttagger.arguments import get_train_argument, get_test_argument
from model.VPhoBertTaggermaster.vphoberttagger.dataset import build_dataset
from model.VPhoBertTaggermaster.vphoberttagger.conlleval import evaluate
...
def train():
    ...
    if args.run_test:
        test_dataset = build_dataset(data_dir = args.data_dir,
                                     tokenizer = tokenizer,
                                     label2id=args.label2id,
                                     header=LABEL_MAPPING[args.task]['header'],
                                     dtype='test',
